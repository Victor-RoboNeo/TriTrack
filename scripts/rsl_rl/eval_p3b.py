#!/usr/bin/env python3
"""P3-B collect features/C_I and rollout learned PI. Frozen Stage-2. λ=1."""
...
parser = argparse.ArgumentParser(description="P3-B collect/rollout. Frozen Stage-2. λ_soft=1.")
...
parser.add_argument("--stage", type=str, default="collect", choices=("collect", "rollout"))
parser.add_argument("--ifs_root", type=str, default=IFS_ROOT)
parser.add_argument("--ckpt_b0", type=str, default="")
parser.add_argument("--ckpt_b1", type=str, default="")
parser.add_argument("--ckpt_b2", type=str, default="")
parser.add_argument("--x_mean_path", type=str, default="")
parser.add_argument("--selected_json", type=str, default="")
parser.add_argument("--models", type=str, default="B0,B1,B2")
...
def main(env_cfg, agent_cfg):
    ...
    print(f"[p3b] ckpt {resume_path} stage={args_cli.stage}", flush=True)
    ...
    for terrain in terrains:
        if args_cli.stage == "collect":
            _run_collect_p3b(env_cfg, agent_cfg, resume_path, args_cli.motion, terrain, out_dir)
        else:
            _run_rollout_p3b(env_cfg, agent_cfg, resume_path, args_cli.motion, terrain, out_dir)
    print(f"[p3b] {args_cli.stage} done", flush=True)
